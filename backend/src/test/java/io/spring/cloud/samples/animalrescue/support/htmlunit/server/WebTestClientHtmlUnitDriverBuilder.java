...
package io.spring.cloud.samples.animalrescue.support.htmlunit.server;
...
/**
 * Blatantly copied from Spring Security code
 * https://github.com/spring-projects/spring-security/tree/master/config/src/test/java/org/springframework/security/htmlunit/server
 *
 * This is to support using WebDriver with WebTestClient rather than MockMvc.
 *
 * @author Rob Winch
 * @since 5.0
 */
